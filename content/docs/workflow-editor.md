...
You can use your existing CI Architecture or if you want to create your own CI Architecture. Click on: [External CI Pipeline](https://docs.devtron.ai/docs/external-ci-pipeline/) 
