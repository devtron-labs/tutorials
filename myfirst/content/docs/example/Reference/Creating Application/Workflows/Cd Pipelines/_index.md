...
![Workflow](/img/workflow-editor8-resize.PNG)
...
![Update CD Pipeline](/img/update_pipeline_cd.jpg "Update CD Pipeline")
...
![Update CD Pipeline](/img/edit_cd_pipeline.jpg "Update CD Pipeline")
...
![Delete CD Pipeline](/img/edit_cd_pipeline.jpg "Delete CD Pipeline")
...
![Add CI Pipeline](/img/cd_pre_build.jpg "Add CD Pipeline")
...
![Add CI Pipeline](/img/cd_post_build.jpg "Add CD Pipeline")
